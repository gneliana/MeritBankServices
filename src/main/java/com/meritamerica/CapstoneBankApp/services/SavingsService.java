...
public class SavingsService {
	...
	public SavingsAccount addSavingsAccount(SavingsAccount account, Integer id) throws AccountNotFoundException {
		...
		user.setSavingsAccounts(Arrays.asList(account));   // use Arrays class to convert array of account to List 
		account.setUser(user);  					 // set list of savings accounts to belong to holder
	...
	public List<SavingsAccount> findAccounts(Integer id) throws AccountNotFoundException {	
		return userService.findById(id).getSavingsAccounts();
	}
}
